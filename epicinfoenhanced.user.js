    ...
    var eie = (function () {
        ...
        eie.prototype.registerMenu = function () {
            ...
            if (_this.authCode == null && _this.user == null) {
                let loginMenuId = GM_registerMenuCommand('登录', function () {
                    ...
                    GM_openInTab('https://www.epicgames.com/id/login?redirectUrl=https%3A%2F%2Fwww.epicgames.com%2Fid%2Fapi%2Fredirect%3FclientId%3D34a02cf8f4414e29b15921876da36f9a%26responseType%3Dcode', false);
                });
        ...
        eie.prototype.getLibrary = async function () {
            ...
            tData.forEach(function (ns) {
                if (namespace[ns]) {
                    library = library.concat(namespace[ns]);
                } else {
                    nstodo.push(ns);
                }
            });
